...
import { LANGUAGES, getFlatLessons, findLesson } from "./data.js?v=1786964007";
import { saveUser, loadUser } from "./storage.js?v=1786964007";
import { registerActivity, dailyGoalProgress, levelFromXp } from "./streak.js?v=1786964007";
import { evaluateBadges, BADGES } from "./badges.js?v=1786964007";
import { buildExercises, speak, checkAnswer, computeLessonReward } from "./lessons.js?v=1786964007";
import { getRangliste, getLeague } from "./rangliste.js?v=1786964007";
import { isOnlineAvailable, syncScoreOnline, subscribeLeaderboardOnline, FIREBASE_ENABLED } from "./online-rangliste.js?v=1786964007";
import { showToast } from "./toast.js?v=1786964007";
import { renderProfil, renderEinstellungen } from "./profile.js?v=1786964007";
import { listPlayers, setBanned, adminResetPassword, adminDeleteAccount } from "./auth.js?v=1786964007";
